...
public:
	...
	virtual Block *OnReceive(sf::Packet*, GameUtility*);
	virtual sf::Packet Block::OnSend(sf::Int16 packetType, long x, long y, short layer, short id, short metadata, GameUtility* gameUtility);
