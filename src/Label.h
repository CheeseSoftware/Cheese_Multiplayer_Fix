...
namespace gui
{
	...
	private:
		...
		sf::Text *m_text;
	public:
		Label(int x, int y, sf::Sprite *texture, sf::String *text, sf::Font *font, int lineLength, int maxLength);
		~Label();
		...
		void setText(std::string text) { m_text->setString(sf::String(text)); };
